    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Input Jenis Pakaian</h3>
        ...
        <div class="box-body">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{url('pakaian')}}" method="POST" autocomplete="on">
                @csrf
              ...
              <div class="box-body p-2">
                  ...
                  <div ></div>
                    ...
                    <input type="hidden" name="id_pakaian" id="id" value="{{$kodeid}}">
                <div class="form-group">
                  <label for="jenis" class="col-sm-2 control-label">Jenis Pakaian</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('nama_jenis') is-invalid @enderror" id="jenis" name="nama_jenis" placeholder="Nama Jenis Pakaian"  value="{{ old('nama_jenis') }}">
                    @error ('nama_jenis')
